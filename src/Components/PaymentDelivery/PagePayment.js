        ...
        <div className="row">            
            <div className="col-lg-6 orderSummary mt-5">
                ...
                <div className="container pt-2 pb-5">
                    ...
                    <div className="card col-8 mx-auto mt-2">
                        <div className="row">
            ...
            <div className="col-lg-6 addressPayment mt-5">
                ...
                <div className="container pt-2 pb-3 mt-2"> 
                    <div class="form-check mt-3 ml-2">
                        <input className="form-check-input mt-2" type="radio" name="flexRadioDefault" id="flexRadioDefault2" checked/>
